...
var Recorder = /** @class */ (function () {
    function Recorder(args) {
        ...
        console.log('[ARC] Recorder Initiated. V 0.2.5');
    }
    return Recorder;
}());
